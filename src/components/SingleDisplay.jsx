// import style from './css/SingleDisplay.module.css';

// const SingleDisplay = (props) => {
//   const { image, name, distance, desc, avail } = props;

//   return (
//     <li className={style.Container}>
//       <img src={image} alt="A home pic" />
//       <ul>
//         <li>{name}</li>
//         <li><b>{desc}</b></li>
//         <li>{distance}</li>
